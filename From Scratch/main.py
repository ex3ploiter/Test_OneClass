...
def performTest(attack_eps):
    ...
    for normal_class in range(10):
        ...
        write_in_file(f"MNIST_{normal_class}_Clean_{attack_eps}_FromScratch.txt", clean_auc)
        write_in_file(f"MNIST_{normal_class}_Adversarial_{attack_eps}_FromScratch.txt", adv_auc)
